...
class Cube:
    ...
    def __init__(self):
        cube = self.random_scramble(self.cube)
    ...
    #         if perms[i] != 0:
    #             self.take_colors(i)  # read colors from taken photo   
    #             self.assign_colors(self.colors_on_photo, perms[i])   # make an transformations of the perms
    ...
    def take_colors(self, image_number):
        ...
        self.colors_on_photo = (colors_down + colors_up)
    ...
    def assign_colors(self, colors_on_photo, rotation):
        ...
        self.colors_on_cube, self.cube_transform =  projected_colors, cube_transformation
