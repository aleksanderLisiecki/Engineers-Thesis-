...
class Cube:
    ...
    def __init__(self):
        ...
        self.colors_on_cube, self.cube_transform = self.assign_colors(self.colors_on_photo, 'R1O1')
    ...
    def take_colors(self):
        ...
        self.colors_down = colors.take_colors(self.coords_down, self.PATH + 'img/kostka_dol_paint.jpg')
        self.colors_up = colors.take_colors(self.coords_up, self.PATH + 'img/kostka_gora_paint.jpg')
